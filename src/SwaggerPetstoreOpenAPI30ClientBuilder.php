...
class SwaggerPetstoreOpenAPI30ClientBuilder
{
    ...
    public function petstoreAuthCredentials(PetstoreAuthCredentialsBuilder $petstoreAuth): self
    {
        $this->config = array_merge($this->config, $petstoreAuth->getConfiguration());
        return $this;
    }
    ...
    public function build(): SwaggerPetstoreOpenAPI30Client
    {
        return new SwaggerPetstoreOpenAPI30Client($this->config);
    }
}
