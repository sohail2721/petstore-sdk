...
namespace SwaggerPetstoreOpenAPI30Lib\Exceptions;
...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \SwaggerPetstoreOpenAPI30Lib\Http\HttpRequest $request
     * @param \SwaggerPetstoreOpenAPI30Lib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \SwaggerPetstoreOpenAPI30Lib\Http\HttpRequest $request,
        \SwaggerPetstoreOpenAPI30Lib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \SwaggerPetstoreOpenAPI30Lib\Models\OAuthProviderErrorEnum::checkValue
     */
